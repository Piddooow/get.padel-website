/**
 * GET /api/availability — slot availability search (PRD Fase 1, backend).
 *
 * Query params:
 * - `date`     (required) YYYY-MM-DD or preset today|tomorrow|weekend
 * - `venue`    (optional) venue id (defaults to the single venue)
 ...
 *
 * Responses: 200 `AvailabilityResponse` · 400 invalid params · 404 unknown court
 */
