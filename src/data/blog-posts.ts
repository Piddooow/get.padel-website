...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: {
      id: "Lima hal yang perlu kamu siapkan sebelum sesi pertamamu di Get Padel, mulai dari sepatu sampai sewa raket.",
    ...
    body: [
      ...
      },
      {
        ...
        en: "Clean sports shoes with non-marking, stud-free soles are required. No racket yet? No problem. Complete, affordable racket rental is available, including kids' rackets. Balls are provided.",
      },
      {
        id: "Booking slot favoritmu lewat kanal resmi AYO atau WhatsApp CS. Slot terbuka hingga sekitar 1 bulan ke depan, dan jam 18.00–22.00 paling cepat penuh, jadi jadwalkan lebih awal ya.",
  ...
  },
  {
    ...
    title: {
      id: "Chasing Sunset: Main Bareng Komunitas Jakarta Timur dan Bekasi",
      en: "Chasing Sunset: Playing with the East Jakarta and Bekasi Community",
    },
    excerpt: {
      id: "Cerita di balik friendly match komunitas kami bersama PadelHub, plus cara ikut sesi Open Match berikutnya.",
      en: "The story behind our community friendly match with PadelHub, plus how to join the next Open Match.",
    },
    date: "2026-08-30",
